...
class _DatePickerModeToggleButtonState
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = colorScheme.onSurface.withOpacity(0.80);
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Flexible(
                          child: Text(
                            widget.title.toPersian,
                            overflow: TextOverflow.ellipsis,
                            style: AppTextStyles.textBtn.copyWith(
                              color: controlColor,
                            ),
                          ),
                        ),
...
class _DayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final TextStyle? dayStyle = AppTextStyles.textBtn;
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Text(formatDecimal(day).toPersian,
                style: AppTextStyles.textBtn.apply(color: dayColor)),
          ),
        );
  ...
  List<Widget> _getDayHeaders(
    ...
    for (int i = firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      ...
      result.add(ExcludeSemantics(
        child: Center(child: Text(weekday.toPersian, style: AppTextStyles.blackBtn)),
      ));
      ...
      child: Container(
        ...
        child: Center(
          child: Semantics(
            selected: isSelected,
            child:
                Text(year.toString().toPersian, style: AppTextStyles.textBtn),
          ),
        ),
      ),
    );
